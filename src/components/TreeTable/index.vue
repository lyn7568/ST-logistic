      ...
      <template slot-scope="scope">
        <slot :scope="scope" :name="item.key">
          <template v-if="item.expand">
            <span :style="{'padding-left':+scope.row._level*indent + 'rem'} "/>
          ...
          <template v-if="item.checkbox">
            <el-checkbox
              ...
              :style="{'padding-left':+scope.row._level*indent + 'rem'} "
          ...
          <template v-if="item.operate && typeof scope.row === 'object'">
            <el-button type="text" v-for="operating in operatingList" :key="operating.index "
